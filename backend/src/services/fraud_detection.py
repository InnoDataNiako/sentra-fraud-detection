...
#         """Vérifie les règles métier simples"""
#         rules_violated = []
#         risk_score = 0.0
...
#             # 'ml_model_version': ml_prediction.get('model_version', 'unknown')  # CORRIGÉ ICI
...
#     ) -> Transaction:
#         """Sauvegarde la transaction en base"""
#         transaction_record = {
#             'transaction_id': transaction_data.get('transaction_id'),
...
#             'fraud_score': decision['combined_risk_score'],
